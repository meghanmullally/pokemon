...
function Header() {
  ...
  const searchOptionData = useAppSelector(
    (state) => state.pokemon.searchOptionData
  );
...
<AppBar position="static">
  <Toolbar className="toolbar">
    <Grid container alignItems="center" justifyContent="space-between">
      <Grid item xs="auto" className="logoContainer">
        <NavLink to="/" onClick={resetFilterTerm}>
          <Hidden mdDown>
            <img src="https://archives.bulbagarden.net/media/upload/4/4b/Pok%C3%A9dex_logo.png" className="pokedex" alt="pokedex image" />
          </Hidden>
          <img
      ...
      <Grid item xs="auto" className="avatarContainer">
        <Typography variant="body2" className="recentSearch">
          Recent Searches:
        </Typography>
        <AvatarGroup max={8}>
